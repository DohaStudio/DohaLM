...
| `v0.3` | 토크나이저 확립 | SentencePiece Unigram, vocabulary 16,000, ADR-003 special token 8개, corpus·artifact manifest와 fingerprint, encode/decode, 한국어 분할·UNK/fallback 평가, 호환성 검사 | 모델 학습·실제 release/tag 생성 | Gate 3 통과 | [Phase 2 토크나이저 상세 계약](../training/phase2-tokenizer-contract.md), [토크나이저 설계](../training/tokenizer-design.md), ADR-003 | TOK-001~012, A/B 후보, round-trip, ID, checksum·atomic publish·호환성 | version 고정 tokenizer bundle·평가·계보 metadata 후보 |
