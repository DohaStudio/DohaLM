...
| 문서 상태 | `review` |
| 마지막 검토일 | 2026-07-23 |
| 선행 문서 | [개발 규칙](./02-development-rules.md), [개발 로드맵](./17-development-roadmap.md), [Definition of Ready](./31-definition-of-ready.md), [테스트 전략](./33-test-strategy.md), [ADR-006](./decisions/ADR-006-development-quality-gates.md) |
| 후속 문서 | [테스트 체크리스트](./18-testing-checklist.md), [Codex 작업 절차](./36-codex-workflow.md) |
