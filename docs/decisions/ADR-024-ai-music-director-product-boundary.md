...
- [제안] DohaMusic은 사용자 작업, project·asset·job과 제품 orchestration을 소유한다.
- [제안] DohaAudio와 DohaVocal은 각각 자신의 audio·vocal 처리와 feature 계산을 소유한다.
...
| 날짜 | 변경 내용 |
|---|---|
| 2026-08-20 | [제안] PR #103의 유효한 제품 방향을 현행 Common ownership과 Foundation 실행 계약에 맞춰 ADR-024로 재작성 |
