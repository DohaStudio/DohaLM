...
| ADR-035 | [Candidate A Product Dataset 계보와 Producer 정책](./ADR-035-candidate-a-product-dataset-provenance-and-producer-policy.md) | `approved` | 2026-09-02 | [ADR-004](./ADR-004-data-governance.md), [ADR-014](./ADR-014-dataset-product-governance-boundary.md), [ADR-034](./ADR-034-cross-repository-rights-authority-and-current-evidence-snapshot.md) | canonical member·`data_file` group·90/5/5 split, record candidate producer와 versioned allocation fingerprint·authority ownership 승인 | Candidate A rebuild; artifact publication·Training 별도 승인 |
...
| ADR-037 | [Large Product Dataset Proposal Manifest-Reference Authority](./ADR-037-large-product-dataset-proposal-manifest-authority.md) | `approved` | 2026-09-02 | [ADR-025](./ADR-025-dataset-version-proposal-authority-contract.md), [ADR-035](./ADR-035-candidate-a-product-dataset-provenance-and-producer-policy.md) | inline v1 호환 유지, bounded manifest-reference v2와 forward-only 0009 승인 | 97,747-member proposal·publication 재개 |
...
- [확정] ADR-035는 Candidate A의 existing `source_id`, hashed `data_file` group, versioned 90/5/5 split과 allocation fingerprint serialization, record-level LearningCandidate producer, source-level Rights·candidate eligibility binding 및 Product Dataset authority input owner를 승인한다.
...
| 날짜 | 변경 내용 |
|---|---|
| 2026-09-02 | [확정] ADR-035 legacy allocation fingerprint provenance defect와 versioned canonical serialization amendment 승인 |
