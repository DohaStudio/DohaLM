...
- [확정] ADR-022는 raw C2/H17을 보존하고 세 독립 adjudication 뒤 residual C1/H15를 수용하는 exact-image C1 local/CI ephemeral-only 30일 risk acceptance이며 C1 구현·production activation은 승인하지 않는다.
