...
| 문서 상태 | `review` |
| 마지막 검토일 | 2026-07-23 |
| 선행 문서 | [평가 계획](./evaluation-plan.md), [데이터 라이선스 정책](../data/data-license-policy.md), [데이터 분할 및 누수 방지](../data/data-split-and-leakage-policy.md), [ADR-005](../decisions/ADR-005-evaluation-and-experiment-policy.md) |
| 후속 문서 | [실험 관리](../training/experiment-management.md), [재현성 정책](../quality/reproducibility-policy.md), `20-leaderboard-strategy.md` 작성 예정 |
