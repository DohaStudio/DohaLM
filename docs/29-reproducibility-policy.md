...
| 문서 상태 | `review` |
| 마지막 검토일 | 2026-07-23 |
| 선행 문서 | [개발 규칙](./02-development-rules.md), [평가 계획](./10-evaluation-plan.md), [실험 관리](./15-experiment-management.md), [산출물 및 설정 정책](./22-artifact-and-configuration-policy.md), [ADR-005](./decisions/ADR-005-evaluation-and-experiment-policy.md) |
| 후속 문서 | [실험 템플릿](./30-experiment-template.md), `18-testing-checklist.md` 작성 예정 |
| 구현 전 필수 여부 | 본 학습 전 예 |
