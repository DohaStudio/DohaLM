...
- 문서 상태: `review`
- 마지막 검토일: 2026-07-23
- 선행 문서: [개발 로드맵](./17-development-roadmap.md), [Definition of Done](./32-definition-of-done.md), [테스트 전략](./33-test-strategy.md), [위험 등록부](./34-risk-register.md)
...
- [확정] 버전 완료는 [Definition of Done](./32-definition-of-done.md)과 해당 단계 게이트를 모두 통과한 경우에만 선언한다.
...
- [확정] 실패 시 [개발 로드맵](./17-development-roadmap.md)의 복구 경로와 [위험 등록부](./34-risk-register.md)의 대응을 적용한다.
