...
| 문서 상태 | `review` |
| 마지막 검토일 | 2026-07-23 |
| 선행 문서 | [프로젝트 개요](./00-project-overview.md), [개발 규칙](./02-development-rules.md), [시스템 아키텍처](./03-system-architecture.md) |
| 후속 문서 | [산출물 및 설정 정책](./22-artifact-and-configuration-policy.md), `15-experiment-management.md` 작성 예정 |
| 구현 전 필수 여부 | 예 |
