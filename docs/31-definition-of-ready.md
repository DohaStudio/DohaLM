...
| 문서 상태 | `review` |
| 마지막 검토일 | 2026-07-23 |
| 선행 문서 | [개발 규칙](./02-development-rules.md), [개발 로드맵](./17-development-roadmap.md), [ADR-006](./decisions/ADR-006-development-quality-gates.md) |
| 후속 문서 | [Definition of Done](./32-definition-of-done.md), [테스트 전략](./33-test-strategy.md), [Codex 작업 절차](./36-codex-workflow.md) |
...
| R-COM-09 | 완료 기준이 정의됨 | [Definition of Done](./32-definition-of-done.md) 항목 | Done 기준 작성 |
