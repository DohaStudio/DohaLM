...
| 문서 상태 | `review` |
| 마지막 검토일 | 2026-07-23 |
| 선행 문서 | [개발 로드맵](./17-development-roadmap.md), [Definition of Done](./32-definition-of-done.md), [테스트 전략](./33-test-strategy.md), [ADR-006](./decisions/ADR-006-development-quality-gates.md) |
