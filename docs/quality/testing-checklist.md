...
| EVAL-006 | EOS generation·decoding 진단 | 4개 길이·11개 profile·15개 synthetic category·privacy·불변성 | Unit/Static/GPU Eval | 예 | 동일 A/B identity, text/token array 미저장, checkpoint/model 불변 | proposed 정책·ADR 승인 전 공식 상태 불변 | 일부 | `implemented`; GPU 동일 조건 진단 대기 |
