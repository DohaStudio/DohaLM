...
| SFT | AIHUB-71748 조건부 선정, Processing Backend Synthetic 검증 완료, 실제 Processing·Training 미승인·미실행 |
| 추론 API | 스캐폴드만 존재, 미구현 |
