...
루트 `AGENTS.md`, [사전학습 계획](../../docs/08-pretraining-plan.md), [GPU 메모리 전략](../../docs/16-gpu-memory-strategy.md), [실험 관리](../../docs/15-experiment-management.md)를 함께 적용한다.
...
- OOM 발생 시 [GPU 메모리 전략](../../docs/16-gpu-memory-strategy.md)의 순서대로 한 번에 하나의 변수를 조정하고 전후 값을 기록한다.
